...
### **_Final Reflection_**
Moving through this process there are a number of key takeaways for me. For one, I learned the value of sketching and storyboarding. It just is not possible to tell if something is going to work in any way, shape, or form, until you take what is in your head and try to map it out on paper or via a digital sketching tool. Similarly, storyboarding plays a pivotal role in the development process in that it helps clarify not only what story you are trying to tell, but how each piece of the story comes together to form a compelling arc. 

I also learned how critical it is to solicit feedback using impartial, unopinionated, and thoughtful questions. This portion of the process truly led me to reevaluate my visualization approach. I think it was important for me to do this exercise asking individuals to look at and interact with the chart themselves, versus my digital storytelling platform that provides more context. Ultimately, I wanted to ensure that the visualizations speak for themselves. I think this approach pushed me to present clearer information and refined my storytelling focus. For example, I could have dug deeper into this information (and perhaps one day will), showing how gender and race within leadership roles varies across different organizational budget sizes; but this more in-depth look would not necessarily allow me to  have both the reach and impact I was aiming for across my three personas.  

### **_My Final Data Story_**
[Now that you have read all about my process - check out my published Shorthand site to see my final data story](https://carnegiemellon.shorthandstories.com/lsaundersfinal/index.html)
